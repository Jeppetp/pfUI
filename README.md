...
### 7.6.0 (February 3, 2026)

**Added:**
- ✅ NPC/Mob handling: Skip Nampower for non-player/non-pet units
- ✅ Focus power type (powerType == 2) for Hunter pets
- ✅ Hide power text for NPCs without power

**Fixed:**
- 🔧 Expose Armor duration (30s fixed for others' casts)
- 🔧 Nil-checks for slotOwnership/displayToAura clearing
